      ...
      <main className="pt-20 min-h-screen" style={{ background: '#FFF8F0' }}>
        <div className="max-w-3xl mx-auto px-4 py-16">
          <div className="bg-white rounded-3xl p-10 shadow-lg">
            ...
            {[
              { title: '1. Acceptance of Terms', content: 'By accessing ZenYoga Bliss services, you agree to these terms. Our services are for general wellness purposes and do not constitute medical advice.' },
              { title: '2. Wellness Services Disclaimer', content: 'ZenYoga Bliss provides Ayurvedic wellness guidance and yoga therapy. These services complement but do not replace professional medical care. Always consult a physician for medical conditions.' },
              ...
              { title: '5. Intellectual Property', content: 'All content, programs, and materials on this website are proprietary to ZenYoga Bliss. Reproduction without permission is prohibited.' },
              ...
              { title: '7. Limitation of Liability', content: 'ZenYoga Bliss is not liable for any indirect damages arising from use of our services. Our liability is limited to the amount paid for services.' },
