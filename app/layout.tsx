...
export const metadata: Metadata = {
  ...
  description: "Transform your mind, body and soul with ZenYoga Bliss. Expert Ayurvedic consultations, yoga therapy, meditation, and holistic wellness programs. 2500+ clients, 98% satisfaction, 8+ years.",
